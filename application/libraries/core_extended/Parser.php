<?php
    ...
    class Parser
    {
         ...
         * @param bool  $bStrict    If true, throws exception if unparsed tags are found in final content
         *
         * @return mixed
         ...
         * @author        Bruno Škvorc <bruno@skvorc.me>
         */
        public function doParse($aTagValues, $mContent, $bStrict = false)
        {
            ...
            if ($bStrict) {
                ...
                $this->finalContentCheck($mContent, $bStrict);
            }
